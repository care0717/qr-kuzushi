{-
   ======================================================================
   Copyright (c) 2017, Pablo Hirafuji
   All rights reserved.

   This source code is copied from https://github.com/pablohirafuji/elm-qrcode/blob/5ddedc18174765550707219166840554fd277a65/src/QRCode/ErrorCorrection.elm
   ======================================================================
-}
...
unsafeGetLog : Int -> Int
unsafeGetLog index =
    getLog index |> Result.withDefault 0
